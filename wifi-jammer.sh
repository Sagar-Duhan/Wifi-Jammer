#!/bin/bash
#Wifi-Jammer v1.0
#Coded by:Sagar Duhan [D@rk_Synt@x]
#Instagram: its_.error._
#Tool to Jamm Wifi with colourful Outfit

#------------------------------------------------------#
# Author                 Sagar Duhan [D@rk_Synt@x]     #
# Instagram              its_.error._                  #
...
echo -e "\033[1;91m\n[!]Tool Created By Sagar Duhan [D@rk_Synt@x] !!! \n\033[1;m"
...
echo " [ BY: Sagar Duhan [D@rk_Synt@x] | Instagram: its_.error._ | v1.0 ]" | pv -qL 40 | lolcat
...
echo -e "                             [ BY: Sagar Duhan [D@rk_Synt@x] | Instagram: its_.error._ | v1.0 ]\n" | pv -qL 20 | lolcat
